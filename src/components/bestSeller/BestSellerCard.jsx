            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 place-items-center">
                {bestSeller.map((item, i) => (
                    <motion.div
                        ...
                        transition={isMobile ? {} : { duration: 0.5, delay: item.delay }}
                    >
                        <div className="md:w-64 w-80 h-60 bg-gradient-to-r from-zinc-300/80 to-zinc-100 dark:to-zinc-800 rounded-md drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)] overflow-hidden">
