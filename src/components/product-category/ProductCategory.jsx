        ...
        <div className="mt-20">
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <SmallCard text={"Ratón"} bgGradient={"from-black/90 to-black/70"} image={mouse} width={"w-[250px]"} bottom={"bottom-0"} right={"-right-16"} bgBtn={"bg-blue-500"}/>
            ...
            <div className="container pt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <SmallCard text={"Ratón"} bgGradient={"from-yellow-500/80 to-yellow-400"} image={mouse} width={"w-[250px]"} bottom={"bottom-0"} right={"-right-16"} bgBtn={"bg-white"} textColorBtn={"text-yellow-500"}/>
